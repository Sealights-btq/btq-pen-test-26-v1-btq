pipeline {
  ...
  environment {
    MACHINE_DNS = 'http://internal-btq-pen-test-26-v1.btq.sealights.co:8081'
    machine_dns = 'http://internal-btq-pen-test-26-v1.btq.sealights.co:8081'
    wait_time = "30"
  }
  stages{
    stage("Init test"){
      steps{
        script{
          git branch: params.BRANCH, url: 'https://github.com/Sealights-btq/btq-pen-test-26-v1-btq.git'
        }
      }
    }
    stage("Setup pnpm") {
